...
Chris Argyris distinguished correcting an error within existing policies from questioning the policies themselves. His account of [double-loop learning](https://hbr.org/1977/09/double-loop-learning-in-organizations) names a central organizational difficulty. A factory can push harder to meet its production target, or ask whether the target is causing defects to be hidden. A support team can answer tickets faster, or question whether speed is being purchased with unresolved problems.
