...
![Three archery targets standing in a row](https://images.unsplash.com/photo-1681752987706-e7345626a5da?ixlib=rb-4.1.0&q=85&fm=jpg&crop=entropy&cs=srgb&w=1600)
{: .figure-wide}

**Precision needs a worthy target.** A tighter group is only an improvement relative to the chosen aim. *[Photo by Mark Stuckey on Unsplash](https://unsplash.com/photos/vgvt2E5C8n8?utm_source=jonathanfrei.com&utm_medium=referral)*
{: .caption}
...
## The person missing from the dashboard
...
The question "better at what?" belongs at the beginning and after every apparent success. The tighter group on the target may show impressive skill. It may also show that the system has become more capable of pursuing an aim that was too narrow from the start.

The danger grows when the optimizer can influence the evidence used to judge it. At that point a bad target no longer produces only bad results. It can produce a steadily improving case that everything is going well.
