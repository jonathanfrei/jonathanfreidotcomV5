...
Guidelines to avoid common AI writing patterns. Source: [tropes.fyi](https://tropes.fyi) by [ossama.is](https://ossama.is)
...
Telling the reader that a point is interesting instead of making the interest evident in the claim. Phrases such as "the most interesting thing," "the interesting thing is," "what makes this interesting," and "interestingly" are throat-clearing. State the substance.

**Avoid patterns like:**
- "The most interesting thing about the project is…"
- "Interestingly, the data shows…"
- "What makes this interesting is that…"

### Empty Noun Crutches

Overuse of "something," "thing," and "things" where a concrete noun would name the object of the sentence. Occasional natural use is fine; clusters signal unfinished thought.

**Avoid patterns like:**
- "trying to recover something the modern world stopped making"
- "stumbled onto something important"
- "not the same thing as mastering it" (when "not the same as mastering it" or a named contrast is clearer)
