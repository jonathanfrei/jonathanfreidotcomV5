...
A country may balance its pension system and automate its factories while each generation remains smaller. That can be sustainable for the forecast period. Eventually the same exercise returns with fewer people available to perform it.

The previous sections have followed one missing person through several ledgers: family, work, public finance, political power, and knowledge. One generation of contraction can be buffered by wealth, migration, automation, and careful reform; five generations reorganize families and institutions around fewer successors; ten make contraction part of the civilization's inherited design.

The path of renewal uses the period of adaptation to rebuild the conditions in which families and generations can carry the inheritance forward. It does not make population growth sufficient for greatness, and it gives the state no claim on anyone's fertility. The other path uses capable administration to make each reduction orderly, allowing maintenance to consume a growing share of the human surplus.

Whether humanity remains a local story is not settled by headcount. Persistent contraction narrows what its successors can attempt. The next chapters ask whether policy, institutions, culture, and more unconventional possibilities can recover that capacity without sacrificing the people renewal is meant to serve.
