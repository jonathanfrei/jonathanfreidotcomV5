...
Long before population became a line on a United Nations chart, it was an argument about limits. Could the number of people outrun the food needed to sustain them? For much of the modern period, that question organized the debate.
{: .lede}
...
The lesson is not that limits are imaginary. Soil and water remain real constraints. It is that population and subsistence are not independent clocks. Technology, mortality, and family aspirations alter both. The demographic transition is the name we give to the most important of those linked changes.
