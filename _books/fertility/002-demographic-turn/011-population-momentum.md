...
Momentum also sets limits on short-term policy. A government can affect migration relatively quickly and may improve conditions for family formation. A cohort born twenty-five years ago cannot be enlarged quickly. Conversely, countries with youthful populations have time to build institutions before aging intensifies, but only if they recognize the transition while the window remains open.
