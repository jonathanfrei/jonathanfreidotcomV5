...
deck: The measures describe different parts of the same demographic movement
...
The **total fertility rate**, or TFR, removes much of that age-structure problem. Demographers calculate birth rates for women at each age and combine them into the number of children a hypothetical woman would have if one year's rates continued throughout her reproductive life. A TFR of 1.5 does not mean the average woman alive has 1.5 children. It summarizes a period.

![South Korea total fertility rate, 1925 to 2020](https://upload.wikimedia.org/wikipedia/commons/thumb/3/39/Total_Fertility_Rate_%28TFR%29_in_Korea.svg/960px-Total_Fertility_Rate_%28TFR%29_in_Korea.svg.png)
...
**Replacement fertility** is the average number of births needed for one generation to replace itself in the long run, absent migration. In a low-mortality population it is often about 2.1 births per woman rather than exactly two because slightly more boys than girls are born and some girls do not survive through the reproductive years. The benchmark is higher where early mortality is higher.
...
- TFR describes the intensity and timing of childbearing in a period.
- Completed cohort fertility records eventual family size for a generation.
- Birth and death rates help explain current population change.
- Replacement describes long-run generational balance under stated mortality conditions.
- Age structure and migration determine how quickly any of those rates appear in the population total.
...
1. Eurostat, [“Fertility statistics”](https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Fertility_statistics), updated 2026.
...
3. Statistics Korea, [*Birth Statistics in 2024*](https://kostat.go.kr/boardDownload.es?bid=11773&list_no=436027&seq=1), 2025.
</div>
