...
The Moon is days away. Mars is months away when the planets are favorably placed. The nearest star, Proxima Centauri, is [about 4.25 light-years from Earth](https://science.nasa.gov/exoplanets/other-stars-other-worlds/our-nearest-celestial-neighbor-an-exotic-3-star-system/), a distance no existing propulsion system makes into a human journey. [Voyager 1 is moving away from the Sun at about 3.5 astronomical units per year](https://science.nasa.gov/mission/voyager/voyager-1/); at that speed, crossing the distance to Proxima would take tens of thousands of years.

“The stars” therefore names a direction and a scale of ambition. The practical work begins nearby with projects such as NASA's current [Moon to Mars architecture](https://www.nasa.gov/moontomarsarchitecture-strategyandobjectives/), which aims at sustained lunar operations and eventual human exploration of Mars. Those are exploration plans. An independent city is a much harder thing.
...
Nothing about population growth guarantees this future. A civilization that no longer replaces itself simply reaches for it with less margin and fewer successors.

<div class="citation">

**Citations**

1. NASA Science, [“Finding Life Beyond Earth: What Comes Next?”](https://science.nasa.gov/universe/search-for-life/finding-life-beyond-earth-what-comes-next/), 2023.
2. NASA Science, [“Our Nearest Celestial Neighbor? An Exotic 3-Star System”](https://science.nasa.gov/exoplanets/other-stars-other-worlds/our-nearest-celestial-neighbor-an-exotic-3-star-system/), 2025.
3. NASA Science, [“Voyager 1”](https://science.nasa.gov/mission/voyager/voyager-1/), 2026.
4. NASA, [“Moon to Mars Architecture: Strategy and Objectives”](https://www.nasa.gov/moontomarsarchitecture-strategyandobjectives/), 2026.
</div>
