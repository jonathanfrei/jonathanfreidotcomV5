...
The higher rungs still matter when a government says it is reversing demographic decline. A baby bonus can move a planned birth forward without changing completed fertility. A national rate can rise while the size of the next generation remains below replacement. This chapter will call a change a durable reversal only when exposed cohorts complete larger families, the gain persists rather than quickly reversing, it improves the succeeding generation's size or age structure, and the mechanism can operate at population scale with its costs and limits visible. It takes years to know whether a policy changed timing, family size, or neither, and no wealthy country has yet demonstrated a reliable policy-led route from very low fertility back to replacement.
