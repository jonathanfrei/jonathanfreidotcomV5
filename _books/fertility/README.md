...
- `/001-.../` through `/010-.../` contain the numbered chapters and conclusion. Each directory begins with `000-introduction.md`; the remaining numbered files are chapter sections. Chapter 7 also holds `ref.md` (chapter plan) and `research/` (per-section source cards for drafting).
