...
This page samples the HTML elements and typographic styles used across the site. Use it when tuning tokens in `_includes/main.css` or checking dark mode and measure. Design system: **The Modern Editorial System** (#110) with self-hosted Source Serif 4 and Source Code Pro (#92) — two custom faces only (serif body + code UI/mono). Source Sans 3 is vendored for later work and is not applied.
